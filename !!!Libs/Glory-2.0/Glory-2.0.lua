...
local MINOR_VERSION = "$Revision: 14737 $"

if not AceLibrary then error(MAJOR_VERSION .. " requires AceLibrary") end
if not AceLibrary:IsNewVersion(MAJOR_VERSION, MINOR_VERSION) then return end

if not AceLibrary:HasInstance("Babble-Zone-2.0") and not AceLibrary:HasInstance("Babble-Zone-2.2") then error(MAJOR_VERSION .. " requires Babble-Zone-2.2 or Babble-Zone-2.0") end
...
local Z = AceLibrary:HasInstance("Babble-Zone-2.2") and AceLibrary("Babble-Zone-2.2") or AceLibrary("Babble-Zone-2.0")
...
if locale ~= "deDE" and locale ~= "koKR" then
	locale = "enUS"
end
