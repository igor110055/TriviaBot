...
local MINOR_VERSION = "$Revision: 15215 $"
...
local function activate(self, oldLib, oldDeactivate)
	...
	local hooksecurefunc = hooksecurefunc or function(alpha, bravo, charlie)
		if not charlie then
			alpha, bravo, charlie = _G, alpha, bravo
		end
		local orig = alpha[bravo]
		alpha[bravo] = function(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)
			local x1,x2,x3,x4,x5,x6,x7,x8,x9,x10 = orig(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)
			charlie(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)
	...
	if not self.hooks.WorldMapFrameCloseButton_OnClick then
		...
		local orig = WorldMapFrameCloseButton:GetScript("OnClick") or function() end
		WorldMapFrameCloseButton:SetScript("OnClick", function(this, arg1)
			if self.WorldMapFrameCloseButton_OnClick then
				self:WorldMapFrameCloseButton_OnClick()
			end
			return orig(this, arg1)
		end)
	end
