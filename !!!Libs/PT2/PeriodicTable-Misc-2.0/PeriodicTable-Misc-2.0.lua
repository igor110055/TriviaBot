...
--[[
Name: PeriodicTable-Misc-2.0
Revision: $Rev: 15137 $
Author: Tekkub Stoutwrithe (tekkub@gmail.com)
Website: http://www.wowace.com/
Description: Misc sets for PeriodicTable-2.0
Dependencies: AceLibrary, PeriodicTable-Core-2.0
...
Be aware that "Relative quality" values may not be consistant across multi-sets
They should only be used in single-set comparisons (IE comparing vials to vials, not vials to herbs)
]]


local vmajor, vminor = "PeriodicTable-Misc-2.0", "$Revision: 15137 $"

if not AceLibrary then error(vmajor .. " requires AceLibrary.") end
if not AceLibrary:HasInstance("PeriodicTable-Core-2.0") then error(vmajor .. " requires PeriodicTable-Core-2.0.") end
...
AceLibrary("PeriodicTable-Core-2.0"):AddModule(vmajor, {
	...
	healthstone = "5509:500 5510:800 5511:250 5512:100 9421:1200 19004:110 19005:120 19006:275 19007:300 19008:550 19009:600 19010:880 19011:960 19012:1320 19013:1440",
	...
	manastone = "5513:600 5514:400 8007:850 8008:1100",
